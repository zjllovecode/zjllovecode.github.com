...
(function (A, w) {
    ...
    c.fn.extend({
        attr: function (a, b) {
            ...
            if (a && typeof a === "string" || a === w)for (var b = (a || "").split(ca), d = 0,
                                                               f = this.length; d < f; d++) {
                var e = this[d];
                if (e.nodeType === 1 && e.className)if (a) {
                    for (var j = (" " + e.className + " ").replace(Aa, " "), i = 0,
                             o = b.length; i < o; i++)j = j.replace(" " + b[i] + " ",
                        " ");
    ...
    (function () {
        ...
        try {
            ...
            z = function (g, h) {
                h = h || [];
                if (j.call(g) === "[object Array]") Array.prototype.push.apply(h, g); else if (typeof g.length === "number")for (var l = 0,
                                                                                                                                     m = g.length; l < m; l++)h.push(g[l]); else for (l = 0; g[l]; l++)h.push(g[l]);
                return h
            }
        }
        var B;
    ...
    c.extend({
        clean: function (a, b, d, f) {
            ...
            for (var b, d, f = c.cache, e = c.event.special, j = c.support.deleteExpando, i = 0,
